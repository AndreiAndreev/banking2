    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            if(document.getElementById("paid") != null) {
                ...
                $pageList.off('click').on('click', msg);
                $first.off('click').on('click', msg);
                $pre.off('click').on('click', msg);
                $next.off('click').on('click', msg);
                $last.off('click').on('click', msg);
                $number.off('click').on('click', msg);
            }
        }
    };
